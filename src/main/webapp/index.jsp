...
<body>
  ...
  <header class="header">
    <div class="header-container margin-inline margin-top-1">
      ...
      <form action="save-signup.jsp" class="input margin-top-1" method="post">
        <input class="input-field" type="email" id="email" name="email" placeholder="email" pattern="[A-Za-z0-9._-]+@[A-Za-z]+\.[a-z]{2,}$" autocomplete="off" required />
